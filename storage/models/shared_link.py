...
class SharedLink(models.Model):
    """
    Sistem Berbagi File/Folder (Link Sharing).
    ...
    # Unik ID untuk URL sharing (misal: awan.com/s/<uuid>)
    ...
    def set_password(self, raw_password):
        """Mengamankan password menggunakan hashing Django."""
        self.password = make_password(raw_password)

    def check_password(self, raw_password):
        """Memverifikasi password yang dimasukkan pengunjung."""
    ...
    @property
    def is_expired(self):
        """Mengecek apakah link sudah melewati batas waktu."""
